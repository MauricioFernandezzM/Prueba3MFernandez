...
public class ModeloSensor {
    ...
    public ModeloSensor(String idSensor, String nombreSensor, String tipoSensor, String valorSensor, String ubicacionSensor, String fechaRegistro, String observacionSensor) {
